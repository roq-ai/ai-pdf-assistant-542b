  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to AI PDF Assistant - Your personal guide to navigating, interpreting, and managing PDF files with the power of Artificial Intelligence."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1612066473428-fb6833a0d855?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSSUyMEFzc2lzdGFudHxlbnwwfHx8fDE2OTkzNTIwOTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@barbarazandoval?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Barbara Zandoval`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to AI PDF Assistant - Your personal guide to navigating, interpreting, and managing PDF files with the power of Artificial Intelligence.`}
            </Text>
            <Box
