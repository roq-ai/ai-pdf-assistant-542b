...
import { useBusinessFindFirst } from 'lib/roq';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const { data, error, isLoading } = useBusinessFindFirst(
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Businesses',
      path: isTenantUser ? `/businesses/view/${data?.id}` : '/businesses',
      entity: 'business',
    ...
    { name: 'Pdfs', path: '/pdfs', entity: 'pdf', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Reminders', path: '/reminders', entity: 'reminder', service: AccessServiceEnum.PROJECT, icon: FiBell },
    { name: 'Tasks', path: '/tasks', entity: 'task', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
